...
from foundation_workflow.design import bearing_pressures
from .haunch_geometry import haunch_cut_depth_check, haunch_cut_error
from databases import load_member_database


PROJECT_ROOT = Path(__file__).resolve().parent.parent
# TODO(advanced-finishes): Complete the haunched-connection analysis; the
# current result remains intentionally conservative.
...
def write_connection_markup_html(
    ...
    from .markup import write_connection_markup_html as write_markup
