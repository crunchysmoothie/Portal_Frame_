...
from .strength import member_class_check, member_design, section_properties
...
DEFAULT_BRACING_DATABASE = (
    Path(__file__).resolve().parent.parent / "databases" / "bracing_member_database.csv"
)
...
def load_bracing_database(
    filename: str | Path = DEFAULT_BRACING_DATABASE,
...
def design_bracing_system(data, member_db, database_path=DEFAULT_BRACING_DATABASE):
