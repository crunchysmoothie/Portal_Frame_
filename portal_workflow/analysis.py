...
from connection_workflow.haunch_design import (
    HaunchProfile,
    TaperedPhysMember,
...
def main(
    ...
    if frame is not None:
        ...
        from reporting_workflow.snapshot import create_analysis_snapshot, write_analysis_snapshot
        from .bracing import design_bracing_system
        from reporting_workflow.calculations import build_calculation_sheet_data_from_frame
