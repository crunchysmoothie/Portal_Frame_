...
ENGINE_SOURCE_FILES = (
    "portal_workflow/analysis.py",
    "connection_workflow/haunch_design.py",
    "connection_workflow/haunch_geometry.py",
    "portal_workflow/bracing.py",
    "portal_workflow/internal_pressure.py",
    "portal_workflow/strength.py",
    "reporting_workflow/visualisation.py",
    "databases/member_database.csv",
    "databases/bracing_member_database.csv",
)
